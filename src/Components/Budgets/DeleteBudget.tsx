...
const DeleteBudget: React.FC<Props> = ({
  setIsDeleting,
  setBudget,
  setIsOptionsOpen,
  isDeleting,
        ...
        <div className="modal-overlay">
          <div className="modal w-[30%] p-8 flex flex-col gap-5 rounded-[12px] ">
            ...
            <button
              ...
              className="text-4-bold w-full bg-red-500 h-auto p-3 text-white rounded-[12px] "
            >
              Yes,Confirm Deletion
            </button>
            <button
              onClick={goBack}
              className="w-full h-auto p-3  rounded-[12px] "
            >
              No,Go Back
            </button>
          </div>
...
export default React.memo(DeleteBudget);
